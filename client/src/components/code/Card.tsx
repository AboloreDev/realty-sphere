...
const Card = ({
  ...
  return (
    <div className="rounded-xl overflow-hidden shadow-lg w-full mb-4 bg-slate-50 dark:bg-slate-950">
      <div className="relative">
        ...
        <div className="absolute bottom-4 left-4 flex gap-2">
          {property.isPetsAllowed && (
            <span className="bg-white/80 text-black dark:bg-black dark:text-white text-xs font-semibold px-2 py-1 rounded-full">
              Pets Allowed
            </span>
          )}
      ...
      <div className="p-4">
        <h2 className="text-xl font-bold mb-1 prata-regular">
          {propertyLink ? (
            <Link
              href={propertyLink}
