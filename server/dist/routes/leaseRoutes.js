...
router.get("/properties/:propertyId/leaseStatus", isAuthenticated_1.isAuthenticated, (0, isAuthenticated_1.restrictTo)("MANAGER"), lease_controller_1.checkPropertyLease);
